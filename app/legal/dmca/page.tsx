...
import { Shield, Mail, FileWarning, Gamepad2 } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#0a0a0a] overflow-hidden">
      ...
      <section className="relative z-10 pt-20 pb-24 sm:pt-28 sm:pb-32">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <FileWarning className="mx-auto w-16 h-16 text-fuchsia-400 mb-6" />
          <h1 className="text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-400 bg-clip-text text-transparent mb-6">DMCA Policy</h1>
          <p className="text-2xl text-white/80 mb-8 font-medium max-w-2xl mx-auto">
            We respect copyright law and respond promptly to valid DMCA takedown requests. Learn how to report copyright infringement below.
          </p>
        </div>
      </section>
      {/* Main Content */}
      <section className="relative z-10 max-w-4xl mx-auto px-6 pb-24">
        <div className="bg-white/10 border border-fuchsia-500/30 rounded-3xl p-8 shadow-2xl mb-10">
          <h2 className="text-2xl font-bold text-white mb-3 flex items-center gap-3"><FileWarning className="w-7 h-7 text-fuchsia-400" />How to File a DMCA Notice</h2>
          <p className="text-lg text-white/70 mb-2">If you believe your copyrighted work has been used on MultiGen in a way that constitutes copyright infringement, please send a DMCA notice to <a href="mailto:dmca@multigen.com" className="underline text-fuchsia-300">dmca@multigen.com</a> with the following information:</p>
          <ul className="list-disc pl-8 text-white/70 text-lg mb-2">
        ...
        <div className="bg-white/10 border border-cyan-500/30 rounded-3xl p-8 shadow-2xl">
          <h2 className="text-2xl font-bold text-white mb-3 flex items-center gap-3"><Shield className="w-7 h-7 text-cyan-400" />Counter-Notification</h2>
          <p className="text-lg text-white/70">If you believe your content was removed in error, you may file a counter-notification with the same contact information above. We will review and respond as required by law.</p>
        </div>
      </section>
      {/* Footer */}
