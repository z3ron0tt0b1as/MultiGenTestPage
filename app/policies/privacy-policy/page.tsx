...
import { Shield, Eye, Lock, Gamepad2 } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#0a0a0a] overflow-hidden">
      ...
      <section className="relative z-10 pt-20 pb-24 sm:pt-28 sm:pb-32">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <Eye className="mx-auto w-16 h-16 text-cyan-400 mb-6" />
          <h1 className="text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-400 bg-clip-text text-transparent mb-6">Privacy Policy</h1>
          <p className="text-2xl text-white/80 mb-8 font-medium max-w-2xl mx-auto">
            Your privacy matters. This policy explains what data we collect, how we use it, and your rights regarding your information.
          </p>
        </div>
      </section>
      {/* Main Content */}
      <section className="relative z-10 max-w-4xl mx-auto px-6 pb-24">
        <div className="bg-white/10 border border-cyan-500/30 rounded-3xl p-8 shadow-2xl mb-10">
          <h2 className="text-2xl font-bold text-white mb-3 flex items-center gap-3"><Eye className="w-7 h-7 text-cyan-400" />What We Collect</h2>
          <p className="text-lg text-white/70 mb-2">We collect only the information necessary to provide and improve our services, such as your email, username, and usage data.</p>
        </div>
        <div className="bg-white/10 border border-fuchsia-500/30 rounded-3xl p-8 shadow-2xl mb-10">
          <h2 className="text-2xl font-bold text-white mb-3 flex items-center gap-3"><Lock className="w-7 h-7 text-fuchsia-400" />How We Use Data</h2>
          <p className="text-lg text-white/70 mb-2">Your data is used to operate MultiGen, personalize your experience, and communicate important updates. We never sell your data.</p>
        </div>
        <div className="bg-white/10 border border-violet-500/30 rounded-3xl p-8 shadow-2xl">
          <h2 className="text-2xl font-bold text-white mb-3 flex items-center gap-3"><Shield className="w-7 h-7 text-violet-400" />Your Rights</h2>
          <p className="text-lg text-white/70">You can request access, correction, or deletion of your data at any time by contacting <a href="mailto:privacy@multigen.com" className="underline text-cyan-300">privacy@multigen.com</a>.</p>
        </div>
      </section>
      {/* Footer */}
